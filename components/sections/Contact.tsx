...
export default function Contact() {
  return (
    <section id="contact" className="py-24 px-4 md:px-10 lg:px-16 items-center justify-center ">
      ...
      <div className="max-w-7xl mx-auto bg-gray-900/20 relative overflow-visible rounded-[3.5rem]  flex flex-col md:flex-row items-end justify-between gap-12 border border-neutral-800/10">
        ...
        <div className="relative z-10 max-w-xl text-left flex flex-col items-start p-10 md:p-16 lg:p-20">
          ...
          <ScrambledText
            className="scrambled-text-demo text-sm text-white"
            radius={100}
            duration={1.2}
            speed={0.5}
            scrambleChars=".:"
